    ...
    <div className="mt-6 border-t border-emerald-800 pt-6 animate-fade-in">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-right">
          <div className="text-3xl font-amiri text-amber-500 leading-extra mb-1">{data.root}</div>
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-2xl font-amiri text-emerald-50 leading-extra">
                  {value.ar}
                </span>
              </div>
      ...
      {data.pattern && (
        <div className="mt-4 p-3 bg-white-10 border border-amber-500 rounded-lg text-center">
          ...
          <span className="text-2xl font-amiri text-amber-400 leading-extra">{data.pattern}</span>
        </div>
      )}
    </div>
  );
